      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex items-center gap-2 p-3 bg-muted/50 rounded-lg">
            ...
            <div>
              <div className="text-sm font-medium text-foreground">Cached Races</div>
              <div className="text-lg font-bold text-foreground">{cacheInfo.raceIds.length}</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 p-3 bg-muted/50 rounded-lg">
            ...
            <div>
              ...
              <div className="text-lg font-bold text-foreground">{formatSize(cacheInfo.totalSize)}</div>
            </div>
          </div>
                ...
                <div key={date} className="space-y-2">
                  ...
                  <div className="ml-4 space-y-1">
                    {entries
                      ...
                      .map(entry => (
                      <div key={entry.raceId} className="flex items-center justify-between p-2 border border-border rounded-lg text-sm bg-card">
                        <div className="flex items-center gap-2">
