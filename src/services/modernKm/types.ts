...
// Balanced weights — v8 (2026-04-27) — Win 36.7%, MRR 0.532
// Calibrated from V5 on current dataset. Best result on current data.
// Key: placePercentage↑1.2, driverForm→2.0, trainerPerformance→0.7, volteStart↓0.9.
